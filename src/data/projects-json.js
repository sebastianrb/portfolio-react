const projects = [
  {
    ...
    "shortDescription": "A showcase of my front-end web development work (and the project you are currently viewing)",
    "description": "This portfolio is built with React and uses JSON data about my projects to dynamically construct the various UI components.",
  ...
  },
  {
    ...
    "description": "I was a lead developer on the team that built a student profile site for Bov Academy, a school for web development. The site contains profiles for the school's student body and implements multimedia and various animation effects via vanilla JavaScript and CSS.",
  ...
  },
  {
    ...
    "description": "This weather app allows the user to search for a city and then calls two weather APIs to provide weather forecasting and clothing recommendations. The app is built with React and Redux.",
  ...
  },
  {
    ...
    "description": "I am an amateur photographer, and this photo gallery app features some of my work. The application is built using the Vue.js JavaScript framework.",
  ...
  },
  {
    ...
    "description": "This is a feature-rich jigsaw puzzle game. The user can ask for hints, reset the game as needed, and increase the difficulty. Be warned: the puzzle is fairly challenging, so pay close attention to the three available hints!",
  ...
  },
  {
    ...
    "description": "The profile app teaches visitors a little bit about me. The site contains a short bio as well as pictures and other information about my background. It is built with vanilla Javascript and jQuery.",
  ...
  },
  {
    ...
    "description": "This app uses AJAX to retrieve a random fact from an API and then displays it. The user can show a new random fact by pressing a button.",
  ...
  },
  {
    ...
    "description": "This application is built using the Handlebars templating engine. It retrieves dozens of random images from the Unsplash API and then displays them in an album-like grid.",
