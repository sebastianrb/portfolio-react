...
export default class ProjectDescription extends React.Component {
	...
	render() {
		...
		if(projectID === "0") {
			portfolioJSONText = <span> You can view the data <a href="https://github.com/sebastianrb/portfolio-react/blob/master/src/data/projects-json.js" target="_blank" rel="noopener noreferrer">here.</a></span>
		} else {
			portfolioJSONText = "";
		}
